...
export default function AccountPage() {
  ...
  return (
    <div>
      <h1 className="font-[family-name:var(--font-syne)] text-2xl font-bold">Account</h1>
      <p className="mt-2 text-sm text-white/50">Change your portal password.</p>
      <form
        onSubmit={onSubmit}
        className="mt-6 max-w-sm space-y-3 border border-white/10 bg-[#141414] p-6"
      >
